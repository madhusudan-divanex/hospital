    ...
    <div style={{ background: "#f3f4f6", padding: 24, fontFamily: "Inter, sans-serif" }}>
      <div style={{ maxWidth: 1150, margin: "0 auto", background: "#fff", border: "1px solid #e5e7eb" }}>
        ...
        <div style={{ padding: "16px 20px", borderBottom: "1px solid #e5e7eb" }}>
          <Row>
            <Col>
              <div style={{ fontSize: 22, fontWeight: 600 }}>Home Visit Invoice</div>
        ...
        <Row style={{ padding: "10px 20px", fontSize: 11, borderBottom: "1px solid #e5e7eb" }}>
          ...
          <Col>VISIT DATE<br /><b>15/04/2026 09:00 AM</b></Col>
          <Col>VISIT TYPE<br /><b>Home Visit · Follow-up</b></Col>
          <Col>BOOKED VIA<br /><b>NeoHealthCard App</b></Col>
          ...
          <Row>
            <Col md={9}>
              ...
              <Row style={{ fontSize: 12 }}>
                ...
                <Col>Previous Visit: 12/04/2026</Col>
              </Row>
              <Row style={{ fontSize: 12 }}>
                <Col>Blood: B+</Col>
        ...
        <div style={{ padding: "14px 20px", borderBottom: "1px solid #e5e7eb", fontSize: 12 }}>
          <Row>
            <Col md={6}>
              ...
              <div><b>Visit Address</b> Flat 204, Sunrise Apts, Andheri East</div>
              <div><b>Arrival Time</b> 09:05 AM</div>
              <div><b>Departure Time</b> 09:35 AM</div>
            </Col>
            <Col md={6}>
              <div><b>Visit Duration</b> 30 minutes</div>
              <div><b>Visit Type</b> Follow-up · Post Discharge</div>
              <div><b>Vitals Taken</b> BP, Temp, Pulse, SpO2, Weight</div>
              <div><b>Condition</b> Stable · Improving</div>
              <div><b>Next Action</b> Continue medicines · CBC in 7 days</div>
            </Col>
          </Row>
        </div>
        ...
        <div style={{ padding: "14px 20px" }}>
          ...
          <Table bordered size="sm">
            ...
            <tbody>
              <tr>
                <td>Home Visit Base Charge</td>
                <td>999319</td>
                <td>0%</td>
                <td>Rs.800.00</td>
              </tr>
              <tr>
                <td>Travel Charge – 4km</td>
                <td>999319</td>
                <td>5%</td>
                <td>Rs.84.00</td>
              </tr>
              <tr>
                <td>Follow-up Clinical Assessment</td>
                <td>999319</td>
                <td>0%</td>
                <td>Rs.200.00</td>
              </tr>
              <tr>
                <td>Prescription Update & Notes</td>
                <td>999319</td>
                <td>0%</td>
                <td>Rs.100.00</td>
              </tr>
          ...
          <div style={{ textAlign: "right", fontSize: 12 }}>
            ...
            <div>GST (Travel) Rs.30.00</div>
            <div style={{ fontWeight: 600 }}>Grand Total Rs.1,030.00</div>
          </div>
        </div>
...
export default HomeVisitInvoice;
