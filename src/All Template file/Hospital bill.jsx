...
// 🔥 100% Pixel-Perfect Hospital Bill (Figma Matched - No Compromise)

const Label = ({ children }) => (
  <p className="text-[10px] text-[#868686] leading-[12px] tracking-[0.02em] mb-[2px]">
    {children}
  </p>
);

const Value = ({ children, bold }) => (
  <p className={`text-[11px] leading-[13px] ${bold ? "font-semibold" : "font-medium"}`}>
    {children}
  </p>
);
...
const Row = ({ title, sub }) => (
  <td className="px-3 py-[6px]">
    <div className="leading-[1.2]">
      <div>{title}</div>
      {sub && (
        <div className="text-[10px] text-[#868686] mt-[2px]">{sub}</div>
      )}
    </div>
  </td>
);

export default function HospitalBillPerfect() {
  return (
    <div className="bg-[#0B0B0B] min-h-screen flex items-center justify-center p-6">
      <div className="w-[880px] bg-white rounded-[6px] shadow-[0_12px_40px_rgba(0,0,0,0.28)] text-[#1C1C1C] text-[12px] relative overflow-hidden">
        ...
        <div className="relative px-6 pt-6 pb-4 border-b border-[#E6E6E6] flex justify-between">
          <div>
            <h1 className="text-[20px] font-semibold leading-[24px]">Hospital Bill</h1>
            <p className="text-[12px] text-[#4A4A4A] mt-[2px]">Apollo General Hospital</p>
            <p className="text-[10px] text-[#868686] mt-[2px]">NHC-H-2022-MH-000009 · Reg. MH-HOSP-2010-00891 · NABH Accredited</p>
            <p className="text-[10px] text-[#868686]">Plot 22, Healthcare Ave, Andheri West, Mumbai – 400053</p>
          </div>

          <div className="flex flex-col items-end gap-[2px]">
            <div className="border border-[#14b8a6] text-[#14b8a6] text-[10px] px-3 py-[2px] rounded-full">
        ...
        <div className="px-6 py-4 border-b border-[#E6E6E6] grid grid-cols-4 gap-4">
          <Meta l="BILL ID" v="NHC-DS-2026-0412-00001" />
        ...
        <div className="px-6 py-5 border-b border-[#E6E6E6] flex">
          <div className="flex-1">
            <h2 className="text-[16px] font-semibold leading-[20px]">Vijay Kumar</h2>

            <div className="grid grid-cols-3 gap-x-5 gap-y-2 mt-3 text-[11px]">
          ...
          <div className="w-[100px] border-l border-[#E6E6E6] pl-4 flex flex-col items-center justify-start">
        ...
        <div className="px-6 py-4 border-b border-[#E6E6E6]">
          <p className="text-center text-[10px] text-[#868686] tracking-[0.02em] mb-2">
            SERVICES & CHARGES
          </p>
            ...
            <tbody>
              {[
                ...
                <tr key={i} className="border-t border-[#E6E6E6]">
                  <Row title={r[0]} sub={r[1]} />
                  <td className="text-center px-3 py-[6px]">999311</td>
                  <td className="text-right px-3 py-[6px]">₹1500.00</td>
                  <td className="text-center px-3 py-[6px]">x2</td>
                  <td className="text-center px-3 py-[6px]">5%</td>
          ...
          <div className="flex justify-end mt-3">
            <div className="w-[220px] text-[12px] leading-[1.4]">
              ...
              <div className="flex justify-between">
                <span className="text-[#868686]">Discount</span>
                <span>-₹1,200</span>
              </div>
              <div className="flex justify-between font-semibold text-[14px] mt-[4px]">
