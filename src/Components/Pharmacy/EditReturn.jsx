...
function EditReturn() {
    ...
    const fetchSupplier = async () => {
        try {
            const response = await getSecureApiData(`api/hospital/supplier/${userId}?type=hospital`);
    ...
    const fetchInventory = async () => {
        try {
            const response = await getSecureApiData(`api/hospital/inventory/${userId}?schedule=all&type=hospital`);
