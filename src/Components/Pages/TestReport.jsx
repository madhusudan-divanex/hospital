                    ...
                    <>
                        <div className="row mb-3">
                            <div className="d-flex align-items-center justify-content-between tp-sub-main-bx">
                                <div>
                                    <h3 className="innr-title mb-2">Test Reports</h3>
                        ...
                        <div className="new-invoice-card">
                            ...
                            <div className="laboratory-header mb-4">
                                <div className="laboratory-name">
                                    <h5>{appointmentData?.labId?.name || 'Advance Lab Tech'}</h5>
                                    <p><span className="laboratory-title">GSTIN :</span> {appointMentId?.labId?.gstNumber || '09897886454'}</p>
                                </div>
                        ...
                        <div className="modal-body px-4">
                            <div className="row ">
                                <div className="col-lg-12">
                                    ...
                                    <div className="pb-5">
                                        <button onClick={(e) => setPrintReport(true)} type="submit" data-bs-dismiss="modal" className="nw-thm-btn w-100 rounded-2"> Print now</button>
                                    </div>
