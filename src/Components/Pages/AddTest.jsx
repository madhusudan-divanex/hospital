...
function AddTest() {
  ...
  const testSubmit = async (e) => {
    ...
    const data = { ...testData, component: components, type: 'hospital', sample: sampleData }
    try {
      const response = await securePostData(`api/hospital/test`, data)
      if (response.success) {
        ...
        : <div className="main-content flex-grow-1 p-3 overflow-auto">
          <div className="row mb-3">
            <div className="d-flex align-items-center justify-content-between tp-sub-main-bx">
              <div>
                <h3 className="innr-title mb-2">Add Test</h3>
