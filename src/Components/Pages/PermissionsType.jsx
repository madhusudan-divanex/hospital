...
function PermissionType() {
  ...
  const addHospitalPermission = async (e) => {
    e.preventDefault()
    if (editId) {
      const data = { hospitalId: userId, name, permissionId: editId }
      try {
      ...
      const data = { hospitalId: userId, name }
      try {
            ...
            <div className="d-flex align-items-center justify-content-between">
              <div className="custom-frm-bx">
                ...
                <div className="search-item-bx">
                  <button className="search-item-btn" onClick={() => fetchHospitalPermission()}><FontAwesomeIcon icon={faSearch} /></button>
                </div>
              </div>
              {totalPage > 1 && <div>
                  ...
                  <table className="table mb-0">
                    ...
                    <tbody>
                      ...
                      {permissions?.length > 0 ?
                        ...
                        <span className="text-black">No permission found</span>}
        ...
        <div className="modal-dialog modal-dialog-centered modal-md">
          <div className="modal-content rounded-5">
            ...
            <div className="modal-body px-4">
              <div className="row ">
                <form onSubmit={addHospitalPermission} className="col-lg-12">
