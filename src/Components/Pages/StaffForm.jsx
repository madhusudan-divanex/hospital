...
function StaffForm() {
    ...
    const validateEmploymentInfo = () => {
        ...
        if (!employmentInfo.fees) newErrors.fees = "Fees is required";
    ...
    const fetchPermission = async () => {
        try {
            const response = await getSecureApiData(`api/comman/permission/${userId}?type=hospital`);
            if (response.success) {
            ...
            {byId ? (
                ...
                <div className="profile-right-card">
                    <div className="profile-tp-header">
                        <h3 className="innr-title mb-2">{searchParams?.get('id') ? 'Edit' : "Add"} Employee</h3>
                    </div>
                                                ...
                                                <div className="col-lg-4 col-md-6 col-sm-12">
                                                    <div className="custom-frm-bx">
                                                        ...
                                                        <input
                                                            ...
                                                            name="fees"
                                                            className="form-control new-control-frm"
                                                            value={employmentInfo.fees}
                                                            onChange={handleEmploymentChange}
                                                        />
                                                        {errors.employment.fees && <small className="text-danger">{errors.employment.fees}</small>}
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
