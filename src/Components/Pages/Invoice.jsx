...
import NeoHealthCardLabTemplates from "./LabBillingTemplate";
...
function Invoice() {
  ...
  const { hospitalBasic, hospitalAddress } = useSelector(state => state.user)
  ...
  const billSubmit = async () => {
    ...
    try {
      const res = await securePostData('api/hospital/lab-payment', data)
      if (res.success) {
                ...
                <div className="new-invoice-card">
                  ...
                  <div className="laboratory-header mb-4">
                    <div className="laboratory-name">
                      <h5>{hospitalBasic?.hospitalName || 'Advance Lab Tech'}</h5>
                  ...
                  <div className="laboratory-report-bx">
                    ...
                    <div className="">
                      <div className="row custom-frm-bx">
